...
/**
 * @brief Affichage de la matrice sans les numéros de lignes / colonnes en haut / à gauche, mais avec un fond de couleur différent pour signifier que la case est à KAIgnorer
 * @param Mat: Matrice gérée par une fonction appelée par la fonction main
 * @author A.Nurdin
 */
...
/**
 * @brief Affichage de la matrice avec les numéros de lignes / colonnes en haut / à gauche et avec un fond de couleur différent pour signifier que la case est à KAIgnorer
 * @param Mat: Matrice gérée par une fonction appelée par la fonction main
 * @author A.Nurdin
 */
...
/**
 * @brief affichage de la matrice avec les numéros de lignes / colonnes en haut / à gauche et avec un fond de couleur différente pour signifier que la case est à KAIgnorer et la case sélectionner a un fond de couleur différent
 * @param Mat: matrice gérée par une fonction appelée par la fonction main
 * @param numLigne: absicsse de la position de la case sélectionnée
...
// pour signifier que la case est à KAIgnorer et la case sélectionnée a un fond de couleur différent
